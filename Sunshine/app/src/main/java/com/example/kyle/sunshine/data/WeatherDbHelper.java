package com.example.kyle.sunshine.data;
...
public class WeatherDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        final String SQL_CREATE_WEATHER_TABLE =
                "CREATE TABLE " + WeatherContract.WeatherEntry.TABLE_NAME + "(" +
                        ...
                        " UNIQUE (" + WeatherContract.WeatherEntry.COLUMN_DATETEXT + ", " + WeatherContract.WeatherEntry.COLUMN_LOC_KEY
                        + ") ON CONFLICT REPLACE);";
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int i, int i2) {
        // Not using user-generated data so we don't care to keep data between versions
